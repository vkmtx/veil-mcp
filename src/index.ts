 ...
 *
 * Modules: config · types · exec (timeout+cap) · effects (effects-as-data) · render
 * (token-aware rendering) · store (addressable output) · tools/{sh_run,sh_detail}.
 * See ARCHITECTURE.md for the feature→module map.
 */
