...
to the maintainer privately via a [GitHub security advisory](https://github.com/vkmtx/veil-mcp/security/advisories/new)
or by contacting [@vkmtx](https://github.com/vkmtx). All complaints will be reviewed
...
1. **Correction** — Community Impact: use of inappropriate language or other behavior
   ...
   the nature of the violation and why it was inappropriate.
